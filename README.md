...
To prevent the bug, close the current tab, [delete or comment this line](https://github.com/PierBover/svelte-rendering-delay-repro/blob/main/src/router.js#L27), and then open a new tab with the app. Now refreshing will be instant, as expected.